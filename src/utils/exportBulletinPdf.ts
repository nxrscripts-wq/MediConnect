...
export function exportBulletinPdf(options: ExportOptions) {
  const { bulletinNumber, healthUnit, month, year, informantName, informantCategory, observations, formData, diseasesPage1, diseasesPage2, months } = options;
